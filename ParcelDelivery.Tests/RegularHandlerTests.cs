...
{
    public class RegularHandlerTests
    {
        private RegularHandler _sut;
        ...
        [Test]
        public void Handle_ShouldSendParcel_IfParcelWeightUnder10kg()
        {
            //  Arrange
        ...
        [Test]
        public void Handle_ShouldMoveToNextHandler_IfParcelWeightOver10kg()
        {
            //  Arrange
